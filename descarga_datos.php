<?php
  ...
  for($j = 0; $j < count($arreglo); $j++){
    ...
    $ins = ingresaDatosContrato($dni,$fechaTermino,$causalTermino,$codigoCargoGenerico,$codigoRef1,$codigoRef2,$idcargo,$idcentrocosto,$fechaInicio,$clasificacionContrato);
